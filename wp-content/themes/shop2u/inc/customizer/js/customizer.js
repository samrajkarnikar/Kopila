( function( api ) {
    ...
    api.sectionConstructor['shop2u-pro'] = api.Section.extend( {
		...
		_init: function() {
            ...
            control.actions = function ($context) {
                if (control.params.live_title_id) {
                    ...
                    if (control.id === 'shop2u_section_order_styling') {
    ...
    function _the_editor( container ){
        var _editor = {
            ...
            ready: function( container ) {
                ...
                control.container.addClass( 'shop2u-editor-added' );
...
jQuery( window ).ready( function( $ ){
    ...
    if ( typeof shop2u_customizer_settings !== "undefined" ) {
        if (shop2u_customizer_settings.number_action > 0) {
            $('.control-section-themes h3.accordion-section-title').append('<a class="theme-action-count" href="' + shop2u_customizer_settings.action_url + '">' + shop2u_customizer_settings.number_action + '</a>');
        }
    }
     ...
     */
    $( 'select[data-customize-setting-link="shop2u_hero_layout"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';

        $( "li[id^='customize-control-shop2u_hcl']").hide();
        $( "li[id^='customize-control-shop2u_hcl"+v+"']").show();

    } );

    $( 'select[data-customize-setting-link="shop2u_hero_layout"]').trigger( 'on_custom_load' );

    /**
     * For Gallery content settings
     */
    $( 'select[data-customize-setting-link="shop2u_gallery_source"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';

        $( "li[id^='customize-control-shop2u_gallery_source_']").hide();
        $( "li[id^='customize-control-shop2u_gallery_api_']").hide();
        $( "li[id^='customize-control-shop2u_gallery_settings_']").hide();
        $( "li[id^='customize-control-shop2u_gallery_source_"+v+"']").show();
        $( "li[id^='customize-control-shop2u_gallery_api_"+v+"']").show();
        $( "li[id^='customize-control-shop2u_gallery_settings_"+v+"']").show();

    } );

    $( 'select[data-customize-setting-link="shop2u_gallery_source"]').trigger( 'on_custom_load' );

    /**
     * For Gallery display settings
     */
    $( 'select[data-customize-setting-link="shop2u_gallery_display"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';
        switch ( v ) {
            case 'slider':
                $( "#customize-control-shop2u_g_row_height, #customize-control-shop2u_g_col, #customize-control-shop2u_g_spacing").hide();
                break;
            case 'justified':
                $( "#customize-control-shop2u_g_col, #customize-control-shop2u_g_spacing").hide();
                $( "#customize-control-shop2u_g_row_height").show();
                break;
            case 'carousel':
                $( "#customize-control-shop2u_g_row_height, #customize-control-shop2u_g_col").hide();
                $( "#customize-control-shop2u_g_col, #customize-control-shop2u_g_spacing").show();
                break;
            case 'masonry':
                $( "#customize-control-shop2u_g_row_height").hide();
                $( "#customize-control-shop2u_g_col, #customize-control-shop2u_g_spacing").show();
                break;
            default:
                $( "#customize-control-shop2u_g_row_height").hide();
    ...
    $( 'select[data-customize-setting-link="shop2u_gallery_display"]').trigger( 'on_custom_load' );
...
jQuery( document ).ready( function( $ ) {
    ...
    display_footer_layout( $( '#customize-control-shop2u_footer_middle_columns select' ).val() );
    $( '#customize-control-shop2u_footer_middle_columns select' ).on( 'change', function ()  {

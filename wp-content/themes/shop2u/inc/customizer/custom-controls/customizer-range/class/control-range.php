<?php
define( 'Shop2u_Range_Version', '1.0.0' );

class Shop2u_Range_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'customizer-range-value-control', get_template_directory_uri() . '/inc/customizer/custom-controls/customizer-range/js/customizer-range-value-control.js', array('jquery'), Shop2u_Range_Version, true );
		wp_enqueue_style( 'customizer-range-value-control', get_template_directory_uri() . '/inc/customizer/custom-controls/customizer-range/css/customizer-range-value-control.css', array(), Shop2u_Range_Version );
	}
 ...
 */
function shop2u_sanitize_range_value( $input ) {
	if ( is_json( $input ) ) {

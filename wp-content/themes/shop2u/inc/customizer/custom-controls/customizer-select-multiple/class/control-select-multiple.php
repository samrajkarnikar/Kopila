<?php
define( 'Shop2u_Multiselect_Version', '1.0.0' );
class Shop2u_Multiselect_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'customizer-select-multiple',get_template_directory_uri() . '/inc/customizer/custom-controls/customizer-select-multiple/js/script-customizer-select-multiple.js',array('jquery'),Shop2u_Multiselect_Version,true);
	}
